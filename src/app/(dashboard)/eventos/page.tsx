  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] w-full max-w-none px-4 py-8 md:px-6 lg:px-8">
      <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">Eventos</h1>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Todos los eventos y actividades de nuestra iglesia.</p>
        </div>
        <Link
          href="/eventos/nuevo"
